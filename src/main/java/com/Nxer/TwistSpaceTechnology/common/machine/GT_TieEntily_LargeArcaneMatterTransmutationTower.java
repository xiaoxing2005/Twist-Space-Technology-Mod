...
public class GT_TieEntily_LargeArcaneMatterTransmutationTower
        extends GTCM_MultiMachineBase<GT_TieEntily_LargeArcaneMatterTransmutationTower>
    ...
    public GT_TieEntily_LargeArcaneMatterTransmutationTower(String aName){super(aName);}
    ...
    public IStructureDefinition<GT_TieEntily_LargeArcaneMatterTransmutationTower> getStructureDefinition() {
        return StructureDefinition.<GT_TieEntily_LargeArcaneMatterTransmutationTower>builder()
                ...
                .addElement('L',ofChain(ofTileAdder(
                                GT_TieEntily_LargeArcaneMatterTransmutationTower::addNodeEnergized,Blocks.air,0),
                        ofBlock(Blocks.air,0)))
                .addElement('M',ofChain(ofTileAdder(
                                GT_TieEntily_LargeArcaneMatterTransmutationTower::addCrucible,blockMetalDevice,0),
